...
#define MISO2 19    // ADC 2 MISO (GPIO pin number)
#define MISO3 20    // ADC 3 MISO (GPIO pin number)
#define MISO4 21    // ADC 4 MISO (GPIO pin number)
#define MISO5 22    // ADC 5 MISO (GPIO pin number)
...
#define SPI_SS 24   // GPIO for slave select (GPIO 24).
#define CLK 23      // GPIO for SPI clock (GPIO 23).
